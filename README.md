...
Interactive data visualization tracking the migration of American jobs, businesses, and investment to India over 25 years. 62 charts across 10 tabs. Built from 844,054 official USCIS filings plus DOL labor condition application data.
...
- **USCIS H-1B Employer Data Hub** — 844,054 individual filings across all 50 states & territories (FY2009–2026), plus FY2026 single-year receipts for the top 100 national and Massachusetts petitioners
- **DOL Foreign Labor Certification LCA Disclosure Data** — Massachusetts labor condition applications with actual job titles, wages, and prevailing wage levels (FY2020, FY2024, and FY2026 Q1)
...
| **H-1B Visas** | Top 20 employers, India's share over time, Indian IT firms breakdown, FY2026 national top-100 snapshot |
| **50-State Data** | State search, all states ranked by H-1B approvals, national approval/denial trends |
| **Massachusetts** | Deep dive into 245K+ approvals, industries, cities, top 20 employers, outsourcing trends, NAICS 54, plus the FY2026 Q1 deep dive (wages, occupations, metros, biotech, academia) |
...
- FY2026 Q1: **2,799** Massachusetts labor condition applications, median offered wage **$127,300**

## Technical

Single-file HTML dashboard using Chart.js 4.4.1 with chartjs-plugin-annotation. No build tools needed — just open `index.html` or deploy to GitHub Pages. 62 interactive charts.

## Refreshing the data

The two FY-quarter sections rebuild automatically from raw government files
via `build.py` and a GitHub Actions workflow. Drop the quarterly USCIS and
DOL files into the `data/` folder and the dashboard regenerates and
redeploys itself. See **[AUTOMATION.md](AUTOMATION.md)** for the full
quarterly workflow.
...
- DOL LCA analysis covers FY2020, FY2024, and FY2026 Q1 (other years exceeded processing limits)
...
- National employer categories (Indian IT / Big Tech / Finance / Consulting) are assigned by a rule-based classifier in `build.py`
